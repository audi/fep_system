...
#ifndef __FEP_RPC_PARTICIPANT_INFO_INTF_H
#define __FEP_RPC_PARTICIPANT_INFO_INTF_H
    ...
    */
    class IRPCParticipantInfo : public IRPCParticipantInfoDef
    {
        ...
        public:
             ...
             * @throw runtime_error if timeout occurred
             */
            virtual std::string getRPCComponentInterfaceDefinition(std::string& rpc_component_name,
                                                                   std::string& rpc_component_iid) const = 0;
    };
}
}
